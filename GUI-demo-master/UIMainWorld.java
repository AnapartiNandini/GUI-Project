...
public class UIMainWorld extends World
{
    ...
    private void testActors()
    {
         ...
         */
        TextBox textbox = new TextBox("How are you",24,true, Color.BLACK, Color.WHITE);
        ...
        Menu menu = new Menu("File" ,"New\nOpen\nSave\nClose\nExit",18,Color.BLACK, Color.WHITE,Color.CYAN, Color.WHITE, new FileCommands());
